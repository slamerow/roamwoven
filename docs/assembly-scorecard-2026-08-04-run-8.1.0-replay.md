...
## RW-CLS-001 — ledger `PARTIAL` — 6 FAIL, 2 NOT BUILT, 3 PASS
...
- Reading: 4 City Note(s) trip-wide; 7 shipped as Activities: "Hundertwasser House", "Museum of Illusions", "Mozarthaus", "Ring Tram Tour", "The Prater", "Leopold Museum", +1 more
...
- Reading: 2 Call(s), 1 claiming source placement; 1 false statement(s) to the maker: "Explore Schönbrunn Palace" tells the maker the source lists 7, but its description names 5 — unlisted: "Ring Tram Tour", "Museum of Illusions"
...
- Reading: 7 child(ren); 5/5 expected present; 2 unexpected: "Ring Tram Tour", "Museum of Illusions"
...
- Field read: `records.items[].parentItemId + .title`
- Reading: 2 wrong member(s): "Ring Tram Tour", "Museum of Illusions"
...
- Reading: 3 child(ren) not traceable to the container's description, and the address path that may have admitted them is unreadable: "Ring Tram Tour", "Trdelník for breakfast", "Museum of Illusions"
