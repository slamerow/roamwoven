...
Trip `4eaf3c6c-f480-442b-8301-c425a032cb87` — 8.1.0. Generated 2026-08-04 by `scripts/scorecard.mjs` in **replay** mode. Scope: RW-ORD-001, RW-CLS-001, RW-GRP-001, RW-PLC-001.
...
| State | Count | Meaning |
|---|---:|---|
| FAIL | 15 | Built, and wrong. A defect or a drift. Investigate. |
...
## RW-ORD-001 — ledger `KNOWN_GAP` — 2 FAIL, 1 NOT BUILT, 2 PASS
...
- Reading: 1: "Prague Castle area beer note" -> "Prague Notes & Tips" (attached)
...
## RW-GRP-001 — ledger `KNOWN_GAP` — 4 FAIL, 1 NOT CHECKABLE, 4 PASS

### FAIL — `GRP-1` Every group child is traceable to source nesting
...
- Reading: 14 grouped stop(s); 10 admitted with the geocode lane OFF and no source nesting: "Trdlnik for breakfast", "KGB museum", "Kafka statue", "St. Vitus Cathedral", "John Lennon Wall", "Mozarthaus", +4 more
...
- Reading: top-level and ungrouped
- Answer key: `docs/assembly-ground-truth-central-europe.md:126` — - ⊕ Prague Castle complex (~2 hrs): sub-stops Changing of the Guard ⏰ 12:00 PM, St. Vitus
...
- Reading: 8 child(ren); 4/5 expected present; 4 unexpected: "Mozarthaus", "The Prater", "St. Charles Church", "Museum of Illusions"
...
- Field read: `records.items[].parentItemId + .title`
- Reading: 1 wrong member(s): "Museum of Illusions"
...
- Reading: the geocode lane is not pinned and stays disabled in replay (replay-pinned-parse.mjs:14); zero verified coordinates exist to compare. Live run 8.1.0 scored this FAIL with 10 collisions, 2 of them distinct venues on a container centroid (docket §2/§4b).
...
- Reading: 2 Call(s), 0 claiming source placement; every source claim is re-derivable from the container's own text
