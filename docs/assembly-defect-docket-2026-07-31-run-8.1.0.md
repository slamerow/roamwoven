...
Illusions and Ring Tram Tour as city notes. **2026-08-05 correction:** its old
Jan-19 `Mumok or Natural History` premise was false; the source has two separate
lines and the current key requires two City Note ideas. This run instead produced a lineage row titled
