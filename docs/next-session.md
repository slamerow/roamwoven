...
- Sensitive-details privacy means private residences, confirmation numbers, and personal notes default to maker-only unless the user explicitly exposes them in the traveler app.
