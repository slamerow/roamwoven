...
const systemPrompt = [
  ...
  "Same-site cluster rule: if multiple sub-stops are clearly part of one complex or visit, create one activity card with sub-stops in the description. For example, a palace visit can include gardens, show, train pass, viewpoints, and related ticket notes in one card. Do not attach unrelated museums, churches, shops, restaurants, or city sights after 'also noted' to the same card.",
  ...
  "City tips rule: never drop general city food ideas, restaurant lists, shopping ideas, beer hall lists, and local tips. Source headers like 'Eat:', 'Food:', 'Bars:', 'Beer halls:', 'Cafes:', 'Restaurants:', or 'Shopping:' are strong city-tip signals when they are loose recommendations rather than chosen dated plans. Create one itemType note with date null, a title that names the city or leg such as 'Prague food ideas', and the list in the description. Phrases like 'check out foods like...', 'some good beer halls are...', or a loose list of options belong in city tips. A reservation, booking, ticket, chosen meal, time, specific dated plan, or day-specific sightseeing cluster stays an activity or flexible activity, not a city tip.",
