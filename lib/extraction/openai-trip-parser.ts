...
const systemPrompt = [
  ...
  "Do not turn medium-confidence contextual guesses into 'calls we made' when changing the guess would move a stay, transport record, or dated traveler card. If the source evidence is not explicit, create one targeted missingDetails question instead.",
