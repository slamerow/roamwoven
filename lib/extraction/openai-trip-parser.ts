...
const systemPrompt = [
  ...
  "Do not ask for optional labels that are not needed to use the traveler app. For example, if a rental car pickup has a date/time/address but no company name, create the transport record and surface a call such as 'We created the rental car pickup without a company name because the source had pickup details but no provider.'",
