...
const systemPrompt = [
  ...
  "For every traveler card in activities, set itemType to activity, restaurant, note, admin, rest_day, social, or placeholder. Restaurants, cafes, bars, winery visits, and meal reservations should usually be restaurant cards, not generic activities.",
