...
export function createCentralEuropeGroundTruthSourceText() {
  return [
    "Sunday, January 13th",
    "Colosseum",
    "Pantheon",
    ...
    "Old Town and Jewish Quarter Hidden Secrets walking tour",
    "Klementinum guided tour",
    "Dinner at Bellevue",
    "",
...
export const groundTruthChecks: GroundTruthCheck[] = [
  ...
  { contract: "RW-GRP-001", id: "castle-same-site-group", label: "Castle records survive top-level when the source does not author containment", status: "enforced" },
  { contract: "RW-GRP-001", id: "schonbrunn-all-stops", label: "Schönbrunn source content survives without inferred containment", status: "enforced" },
