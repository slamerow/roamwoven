...
const itemExpectations = [
  ...
  },
  {
    ...
    date: "2019-01-17",
    description: "Pick up rental car for the Kutna Hora day trip.",
    id: "jan17-rental-car",
...
const stayExpectations = [
  ...
  },
  {
    ...
    checkIn: "2019-01-14",
    checkOut: "2019-01-18",
    id: "jan14-stay-airbnb",
    label: "Prague Airbnb",
    name: "Prague Airbnb",
    requiredKeywords: ["prague", "airbnb"],
  },
  {
    address: "Mariahilfer Strasse 137, Vienna",
    checkIn: "2019-01-18",
    checkOut: "2019-01-21",
    id: "jan18-stay-wombats",
    label: "Wombats Hostel",
    name: "Wombats City Hostel Vienna",
    requiredKeywords: ["wombats"],
  },
  {
