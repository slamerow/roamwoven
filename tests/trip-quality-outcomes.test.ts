...
function report(
  ...
  return {
    ...
    extraction: { activityChunks: null, assemblyDecisionLedger: null, extractionSampling: null, geocodeVerification: null, sourceCoverage: null, sourceFactAssemblyAuthority: null, sourceFactLedger: null, sourceRecovery: null, staged: true },
    fingerprints: {
      hash: "fingerprint",
      sections: {},
      version: 1,
