...
grant select, insert, update, delete on trip_material_ocr_batches to anon;
grant select, insert, update, delete on trip_evidence_observations to anon;
grant select, insert, update, delete on trip_canonical_pieces to anon;
...
grant select, insert, update, delete on trip_material_ocr_batches to authenticated;
grant select, insert, update, delete on trip_evidence_observations to authenticated;
...
grant select, insert, update, delete on trip_material_ocr_batches to service_role;
grant select, insert, update, delete on trip_evidence_observations to service_role;
